...
export const career: CareerItem[] = [
  ...
  },
  {
    ...
    tags: ["Next.js", "JavaScript", "Commerce", "Admin"],
  ...
  },
  {
    ...
    work: [
      "가맹점 및 배달기사 Admin 개발",
      "Node.js, MongoDB 기반 Backend 기능 개발",
  ...
  },
  {
    ...
    company: "리버밴스",
    title: "Uniswap 기반 DEX Swap 서비스",
    summary:
      "Uniswap API 기반 Swap 서비스의 프론트엔드와 백엔드 기능을 구현하고, Swap 관련 Solidity Smart Contract 구현에 참여했습니다.",
    tags: ["React", "Node.js", "Solidity", "Uniswap", "DEX"],
    work: [
      "Uniswap API 기반 Swap 서비스 개발",
  ...
  },
  {
    ...
    summary: "종합소득세 운영관리 웹 애플리케이션, Admin 관리 페이지, 사업자별 장부 및 재무 데이터 화면을 개발했습니다.",
    tags: ["EJS", "jQuery", "Node.js", "MySQL", "Admin"],
    work: ["종합소득세 운영관리 Web Application 개발", "Admin 관리 페이지 개발", "사업자별 장부, 손익계산서, 재무제표 관련 데이터 UI 개발"],
    impact: ["세무 데이터 중심의 운영관리 화면 구현", "관리자 화면과 데이터 테이블 UI 개발 경험 확보"],
  },
  {
    ...
    work: ["React Native 기반 Blockchain Wallet App 개발", "iOS/Android App 출시 참여", "Firebase Analytics 및 Realtime Database 활용"],
    impact: ["모바일 앱 출시 프로세스 경험", "블록체인 지갑 서비스의 사용자 화면 개발 경험"],
  },
  {
    period: "2016.09 - 2018.01",
    company: "클라우드게이트 / 야스",
    title: "게임 UI, 장비용 Windows Application",
    summary: "DirectX11/Unigine 기반 스크린 야구 게임 UI와 C#/WinForms 기반 진공 장비 소프트웨어를 개발했습니다.",
    tags: ["C++", "C#", "DirectX11", "Unigine", "WinForms"],
    work: [
      "국내/일본 레전드야구존 Live Service 유지보수",
      "DirectX11 기반 Kiosk UI 및 Unigine Engine 기반 In-game UI 구현",
      "진공 장비용 C#/WinForms Windows Application 개발",
    ],
    impact: ["상용 게임 UI, Sound, Effect, Data Table 개발 경험", "장비 제어 환경에서 동작하는 Windows Application 개발 경험"],
  },
];
